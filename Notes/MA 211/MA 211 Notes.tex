...
% Create a graph for demontrating the idea of finding limits from a graph
...
In this section we now extend our undestandings of derivatives to all points in the domain $f$ to create new function called the derivative of $f$.


\subsubsection{The Derivative Function}
Due to the fact that the tangent of any given function moves, the slope of the tangent line will also change. For this reason, the slope on the tangent line for the function $f$ is itself a function, call the \emph{derivaive} of $f$.
